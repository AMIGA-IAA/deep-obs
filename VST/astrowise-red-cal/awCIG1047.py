...
target = 'CIG1047'
cigra, cigdec = 359.2, 1.3

# PHOTOMETRY FOR ALL NIGHTS
# 	1227600 	10/11-Oct-2015 	05:57:20 > 06:58:10 	CIG1047_1 	A 	weather comments
#	1418755 	18/19-Oct-2016 	00:37:43 > 01:36:25 	CIG1047_7 	A 	weather comments
#	1418739 	20/21-Oct-2016 	00:06:42 > 01:07:08 	CIG1047_2 	A 	weather comments
#	1418743 	20/21-Oct-2016 	01:07:20 > 02:04:54 	CIG1047_3 	B 	weather comments
#	1418746 	22/23-Oct-2016 	00:06:03 > 01:06:45 	CIG1047_4 	A 	weather comments
#	1418752 	24/25-Oct-2016 	00:03:50 > 01:06:05 	CIG1047_6 	A 	weather comments
#	1418749 	24/25-Oct-2016 	02:02:28 > 03:01:59 	CIG1047_5 	A 	weather comments 
# 5 observing nights in total: 10/11-Oct-2015, 18/19-Oct-2016, 20/21-Oct-2016, 22/23-Oct-2016, 24/25-Oct-2016

date_start, date_end = [datetime.datetime(2015, 10, 10),  datetime.datetime(2015, 10, 11)]
...
date_start, date_end = [datetime.datetime(2016, 10, 18),  datetime.datetime(2016, 10, 19)]
date_query = ((RawScienceFrame.DATE_OBS>date_start)&(RawScienceFrame.DATE_OBS<date_end)&(RawScienceFrame.OBJECT=='STD,ZEROPOINT'))
len(date_query)                   
names = [i.filename for i in date_query]
len(names)
...
date_start, date_end = [datetime.datetime(2016, 10, 22),  datetime.datetime(2016, 10, 23)]
date_query = ((RawScienceFrame.DATE_OBS>date_start)&(RawScienceFrame.DATE_OBS<date_end)&(RawScienceFrame.OBJECT=='STD,ZEROPOINT'))
len(date_query)                   
names = [i.filename for i in date_query]
len(names)
...
date_start, date_end = [datetime.datetime(2016, 10, 24),  datetime.datetime(2016, 10, 23)]
date_query = ((RawScienceFrame.DATE_OBS>date_start)&(RawScienceFrame.DATE_OBS<date_end)&(RawScienceFrame.OBJECT=='STD,ZEROPOINT'))
len(date_query)                   
names = [i.filename for i in date_query]
len(names)
