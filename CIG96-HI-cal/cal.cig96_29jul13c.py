...
### EVLA DATA REDUCTION
### Project: 13A-341
### Dataset date: 29jul13c
### Original dataset name: 13A-341.sb24028522.eb24167589.56502.4165297338.ms
### Renamed as: cig96_14.ms
###
### Configuration: C (9/10)
...
# importevla(asdm='cig96_14', vis='cig96_14.ms')

# Original data file gets now CASA format and a new name: "cig96_14.ms"
...
# flagdata(vis='cig96_14.ms', mode='manual', field='0')

# We run plotms to inspect the general aspect of the data:

#plotms(vis='cig96_14.ms',xaxis='channel',yaxis='amp',field='1',spw='0',coloraxis='field',avgtime='1e9')
#plotms(vis='cig96_14.ms',xaxis='time',yaxis='amp',field='1',spw='0',coloraxis='field',avgchannel='1e9')
...
gencal(vis='cig96_14.ms', caltable='cig96_14.ms.antpos', caltype='antpos')
...
plotants(vis='cig96_14.ms',figfile='cig96_14.ms.plotants.png')
...
flagdata(vis='cig96_14.ms', mode='manual', field='', antenna='ea19', flagbackup=True)

### Shadowing correction over the whole .ms:

flagdata(vis='cig96_14.ms', mode='shadow', flagbackup=True)
...
flagdata(vis='cig96_14.ms', mode='clip', clipzeros=True, flagbackup=True)

# Percentage of data flagged in table selection: 0.000708483%


### Field 1 (bandpass and flux calibrator): quacking of the first 30 seconds (all antennas showing low amplitudes):

flagdata(vis='cig96_14.ms', mode='quack', field='1', quackinterval=30.0, quackmode='beg')

# bad antennas:

flagdata(vis='cig96_14.ms', mode='manual', scan='2', antenna='3&5', correlation='LL', flagbackup=True)

# there are some baselines that show a higher Amp in Amp vs channel plot, we remove them:

flagdata(vis='cig96_14.ms', mode='manual', scan='2', antenna='5&15', correlation='LL', flagbackup=True)
flagdata(vis='cig96_14.ms', mode='manual', scan='2', antenna='5&6', correlation='RR', flagbackup=True)
flagdata(vis='cig96_14.ms', mode='manual', scan='2', antenna='6&19', correlation='RR', flagbackup=True)
flagdata(vis='cig96_14.ms', mode='manual', scan='2', antenna='6&22', correlation='RR', flagbackup=True)
flagdata(vis='cig96_14.ms', mode='manual', scan='2', antenna='11&22', correlation='LL', flagbackup=True)
...
# flagdata(vis='cig96_14.ms', mode='manual', field='2', antenna='3&5', correlation='LL', flagbackup=True)
# Decission: we let them be.

# Quacking needed:

flagdata(vis='cig96_14.ms', mode='quack', field='2', quackinterval=5.0, quackmode='beg')
...
flagdata(vis='cig96_14.ms', mode='manual', field='2', spw = '0:330~380')

# and a small one in ~1250:

# THIS ONE IS NOT SHOWING THIS TIME SO NO NEED TO REMOVE THIS CHANNEL:
# flagdata(vis='cig96_14.ms', mode='manual', field='2', antenna='4&8', spw = '0:1253')

# and the MW HI emission in ~1960:

flagdata(vis='cig96_14.ms', mode='manual', field='2', spw = '0:1940~1975')
...
flagdata(vis='cig96_14.ms', mode='quack', field='3', quackinterval=10.0, quackmode='beg')

# 4&8 baseline in scan 9 is not working well at the end, we remove the last seconds of this baseline:

flagdata(vis='cig96_14.ms', mode='manual', scan='9', antenna='8&24', timerange='10:55:00~10:57:50', flagbackup=True)

# same RFI in ~350 and MW emission as in field 2; no RFI in ~1250:

flagdata(vis='cig96_14.ms', mode='manual', field='3', spw = '0:330~380')
flagdata(vis='cig96_14.ms', mode='manual', field='3', spw = '0:1940~1975')
...
# myTau = plotweather(vis='cig96_14.ms', doPlot=T)
# display cig96_14.ms.plotweather.png
# gencal(vis='cig96_14.ms', caltype='opac', caltable='cig96_14.ms.opcac', parameter=myTau)
...
# gencal(vis='cig96_14.ms', caltype='gceff', caltable='cig96_14.ms.gaincurve')
...
gaincal(vis='cig96_14.ms', caltable='cig96_14.ms.delays', field='1', refant='ea10', gaintype='K', gaintable=['cig96_14.ms.antpos'])
...
setjy(vis='cig96_14.ms', listmodels=T)
...
setjy(vis='cig96_14.ms', field='1', modimage='/mnt/scops/data/data/paramimo/casapy-42.2.30986-1-64b/data/nrao/VLA/CalModels/3C48_L.im')
...
gaincal(vis='cig96_14.ms', caltable='cig96_14.ms.bpphase5s', field='1', refant='ea10', calmode='p', solint='5s', minsnr=5.0, gaintable=['cig96_14.ms.antpos', 'cig96_14.ms.delays'])
...
#plotcal(caltable='cig96_14.ms.bpphase5s', xaxis='time', yaxis='phase')

# Apply phase solutions on the fly:

bandpass(vis='cig96_14.ms', caltable='cig96_14.ms.bandpass5s', field='1', refant='ea10', solint='inf', solnorm=T, minsnr=3.0, minblperant=3, gaintable=['cig96_14.ms.bpphase5s', 'cig96_14.ms.antpos', 'cig96_14.ms.delays'], interp=['nearest'])

# We check again the solutions:

#plotcal(caltable='cig96_14.ms.bpphase5s', field='1', xaxis='time', yaxis='phase')  
...
gaincal(vis='cig96_14.ms',caltable='cig96_14.ms.intphase', field='1,2', refant='ea10', calmode='p', solint='5s', minsnr=5.0, gaintable=['cig96_14.ms.antpos', 'cig96_14.ms.delays', 'cig96_14.ms.bandpass5s'])
...
gaincal(vis='cig96_14.ms', caltable='cig96_14.ms.scanphase', field='1,2', refant='ea10', calmode='p', solint='inf', minsnr=5.0, gaintable=['cig96_14.ms.antpos', 'cig96_14.ms.delays', 'cig96_14.ms.bandpass5s'])

# Derive amplitude solutions:

# time.sleep(5)

gaincal(vis='cig96_14.ms', caltable='cig96_14.ms.amp', field='1',  refant='ea10', calmode='ap', solint='inf', minsnr=5.0, gaintable=['cig96_14.ms.antpos', 'cig96_14.ms.delays', 'cig96_14.ms.bandpass5s', 'cig96_14.ms.intphase'], gainfield=['','','','1'],append=True)

gaincal(vis='cig96_14.ms', caltable='cig96_14.ms.amp', field='2',  refant='ea10', calmode='ap', solint='inf', minsnr=5.0, gaintable=['cig96_14.ms.antpos', 'cig96_14.ms.delays', 'cig96_14.ms.bandpass5s', 'cig96_14.ms.intphase'], gainfield=['','','','2'],append=True)
...
# #plotcal(caltable='cig96_14.ms.amp', xaxis='time', yaxis='amp', iteration='antenna', subplot=331)
# #plotcal(caltable='cig96_14.ms.amp', xaxis='time', yaxis='amp', iteration='baseline', subplot=331)
...
myflux = fluxscale(vis='cig96_14.ms', caltable='cig96_14.ms.amp', fluxtable='cig96_14.ms.flux', reference='1', transfer='2', incremental=False)

# Result:
# Flux density for J0238+1636 in SpW=0 (freq=1.40523e+09 Hz) is: 0.738199 +/- 0.00179706 (SNR = 410.781, N = 52)
...
applycal(vis='cig96_14.ms', field='1', gaintable=['cig96_14.ms.antpos', 'cig96_14.ms.delays', 'cig96_14.ms.bandpass5s', 'cig96_14.ms.intphase', 'cig96_14.ms.flux'], gainfield=['','','','1',''], calwt=F)

# time.sleep(5)

applycal(vis='cig96_14.ms', field='2', gaintable=['cig96_14.ms.antpos', 'cig96_14.ms.delays', 'cig96_14.ms.bandpass5s', 'cig96_14.ms.intphase', 'cig96_14.ms.flux'], gainfield=['','','','2',''], calwt=F)

# time.sleep(5)

# For the target sources we use the scanphase.gcal table:

applycal(vis='cig96_14.ms', field='3', gaintable=['cig96_14.ms.antpos', 'cig96_14.ms.delays', 'cig96_14.ms.bandpass5s', 'cig96_14.ms.scanphase', 'cig96_14.ms.flux'], gainfield=['','','','2',''], calwt=F)
...
# cvel(vis='cig96_14.ms', outputvis='cig96_14.ms.cvel', mode='velocity', field='', spw='0', restfreq='1.42040575177GHz', outframe='LSRK', veltype='radio')
# 
# 
# # ===============================================================================
# 
...
# 
# split(vis='cig96_14.ms.cvel', datacolumn='corrected', outputvis='cig96_14.cvel.corr.ms', field='3', spw='0:400~1700')
# 
...
# 
# # split(vis='cig96_14.ms', datacolumn='corrected', outputvis='cig96_14.corr.spw0.ms', field='3', spw='0')
# 
...
# 
# # split(vis='cig96_14.ms', datacolumn='corrected', outputvis='cig96_14.corr.emission.ms', field='3', spw='0:780~1600')
# 
# # Splitting CIG96 fields in spw=0 with time binning of 20s and channel width of 10 channels:
# 
# split(vis='cig96_14.ms.cvel', datacolumn='corrected', outputvis='cig96_14.corr.20s.10chan.ms', width=10, timebin='20s', field='3', spw='0:451~1700')
# 
# # ===============================================================================
# 
...
# 
# uvcontsub(vis='cig96_14.cvel.corr.ms', field='0', fitspw='0:50~350;900~1050', fitorder=1)
# uvcontsub(vis='cig96_14.corr.20s.10chan.ms', field='0', fitspw='0:15~30;90~105', fitorder=1)
# 
...
# 
# # uvcontsub(vis='cig96_14.corr.emission.ms', field='0', fitspw='0:0~510;710~1300')
# 
# # For the time-channel binned file, we subtract as follows:
# 
# # uvcontsub(vis='cig96_14.corr.20s.10chan.ms', field='0', fitspw='0:45~93;110~181')
# 
# # For the whole spw 0 we use an as extended as possible continuum:
# 
# # uvcontsub(vis='cig96_14.corr.spw0.ms', field='0', fitspw='0:300~365;396~460;490~920;1110~1520')
# 
# # ===============================================================================
# 
...
# 
# clean(vis='cig96_14.cvel.corr.ms.contsub', imagename='cig96_14.cvel.corr.contsub.natural.line', field='0', spw='0:450~800', mode='frequency', start=450, nchan=351, niter=10000, width='48.830kHz', threshold='1.5mJy', interactive=T, npercycle=100, imsize=[200,200], phasecenter='', cell='8.0arcsec', restfreq='1.42040575177GHz', weighting='natural', usescratch=T)
# 
# # Beam size:  arcsec2
# 
# # Weighting uniform:
# 
# clean(vis='cig96_14.corr.ms.contsub', imagename='cig96_14.corr.v3.contsub.uniform.line', field='0', spw='0:510~730', mode='channel', start=0, niter=10000, threshold='1.2mJy', interactive=T, npercycle=100, imsize=[200,200], phasecenter='', cell='15.0arcsec', restfreq='1.4204GHz', weighting='uniform', usescratch=T)
# 
# # Beam size: 
# 
# # Weighting Briggs rob=0.0:
# 
# clean(vis='cig96_14.corr.ms.contsub', imagename='cig96_14.corr.v3.contsub.rob0.0.line', field='0', spw='0:510~730', mode='channel', start=0, niter=10000, threshold='1.2mJy', interactive=T, npercycle=100, imsize=[200,200], phasecenter='', cell='15.0arcsec', restfreq='1.4204GHz', weighting='briggs', robust='0.0', usescratch=T)
# 
# # Beam size: 
# 
# # Collapse of cube (moments):
# 
# immoments(imagename='cig96_14.cvel.corr.contsub.natural.line.image', axis='spectral', moments=[0,1], outfile='cig96_14.cvel.corr.contsub.natural.line.image.mom')
# 
# 
...
# 
# ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ----
# (cig96_14.corr.contsub.line.image)
...
# # Weighting natural:
# 
# clean(vis='cig96_14.corr.20s.10chan.ms.contsub', imagename='cig96_14.corr.20s.10chan.ms.contsub.natural.line.image', field='0', spw='0:93~110', mode='channel', start=0, niter=1000, threshold='1.2mJy', interactive=T, npercycle=100, imsize=[200,200], phasecenter='', cell='15.0arcsec', restfreq='1.4204GHz', weighting='natural', usescratch=T)
# 
# # For the spw 0 split dataset:
# 
# clean(vis='cig96_14.corr.spw0.ms.contsub', imagename='cig96_14.corr.spw0.ms.contsub.natural.line', field='0', spw='0:920~1110', mode='channel', start=920, nchan=190, niter=10000, threshold='1.2mJy', interactive=T, npercycle=100, imsize=[200,200], phasecenter='', cell='10.0arcsec', restfreq='1.4204GHz', weighting='natural', usescratch=T)
# 
# # ===============================================================================
# 
...
# 
# split(vis='cig96_14.ms', datacolumn='corrected', outputvis='cig96_14.corr.v2.ms', field='3', spw='0:399~2047')
# split(vis='cig96_14.ms', datacolumn='corrected', outputvis='cig96_14.corr.allfields.ms', field='1~3', spw='0')
# 
# # and redo uvcontsub:
# 
...
# 
# uvcontsub(vis='cig96_14.corr.v2.ms', field='0', fitspw='0:0~510;730~1300')
# 
# # Cleaning: weighting natural:
# 
# clean(vis='cig96_14.corr.v2.ms.contsub', imagename='cig96_14.corr.v2.contsub.natural.line', field='0', spw='0:510~730', mode='channel', start=0, niter=10000, threshold='1.2mJy', interactive=T, npercycle=100, imsize=[300,300], phasecenter='', cell='15.0arcsec', restfreq='1.4204GHz', weighting='natural', usescratch=T)
# 
# 
# 
# 
