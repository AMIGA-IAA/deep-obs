...
# importevla(asdm='cig96_12', vis='cig96_12.ms')

# Original data file gets now CASA format and a new name: "cig96_12.ms"
...
# flagdata(vis='cig96_12.ms', mode='manual', field='0')

# We run plotms to inspect the general aspect of the data:

#plotms(vis='cig96_12.ms',xaxis='channel',yaxis='amp',field='1',spw='0',coloraxis='field',avgtime='1e9')
#plotms(vis='cig96_12.ms',xaxis='time',yaxis='amp',field='1',spw='0',coloraxis='field',avgchannel='1e9')
...
gencal(vis='cig96_12.ms', caltable='cig96_12.ms.antpos', caltype='antpos')
...
plotants(vis='cig96_12.ms',figfile='cig96_12.ms.plotants.png')
...
flagdata(vis='cig96_12.ms', mode='manual', field='', antenna='ea19', flagbackup=True)

### Shadowing correction over the whole .ms:

flagdata(vis='cig96_12.ms', mode='shadow', flagbackup=True)

# Percentage of data flagged in table selection: 0.516974%


### Zero clipping correction over the whole .ms: 

flagdata(vis='cig96_12.ms', mode='clip', clipzeros=True, flagbackup=True)
...
flagdata(vis='cig96_12.ms', mode='quack', field='1', quackinterval=30.0, quackmode='beg')

# bad antennas:

flagdata(vis='cig96_12.ms', mode='manual', scan='2', antenna='3&5', correlation='LL', flagbackup=True)
flagdata(vis='cig96_12.ms', mode='manual', scan='2', antenna='6&19', correlation='RR', flagbackup=True)
flagdata(vis='cig96_12.ms', mode='manual', scan='2', antenna='11&22', correlation='LL', flagbackup=True)
flagdata(vis='cig96_12.ms', mode='manual', scan='2', antenna='6&11', correlation='RR', flagbackup=True)
flagdata(vis='cig96_12.ms', mode='manual', scan='2', antenna='2&22', correlation='LL', flagbackup=True)
flagdata(vis='cig96_12.ms', mode='manual', scan='2', antenna='6&17', correlation='RR', flagbackup=True)
flagdata(vis='cig96_12.ms', mode='manual', scan='2', antenna='5&15', correlation='LL', flagbackup=True)
...
# flagdata(vis='cig96_12.ms', mode='manual', field='2', antenna='3&5', correlation='LL', flagbackup=True)
# Decission: we let them be.

# Quacking needed:

flagdata(vis='cig96_12.ms', mode='quack', field='2', quackinterval=5.0, quackmode='beg')
...
flagdata(vis='cig96_12.ms', mode='manual', field='2', spw = '0:330~380')

# and a small one in ~1250:

flagdata(vis='cig96_12.ms', mode='manual', field='2', antenna='4&8', spw = '0:1253')

# and the MW HI emission in ~1960:

flagdata(vis='cig96_12.ms', mode='manual', field='2', spw = '0:1940~1975')
...
flagdata(vis='cig96_12.ms', mode='quack', field='3', quackinterval=10.0, quackmode='beg')

# same RFI in ~350 and MW emission as in field 2; no RFI in ~1250:

flagdata(vis='cig96_12.ms', mode='manual', field='3', spw = '0:330~380')
flagdata(vis='cig96_12.ms', mode='manual', field='3', spw = '0:1940~1975')
...
# myTau = plotweather(vis='cig96_12.ms', doPlot=T)
# display cig96_12.ms.plotweather.png
# gencal(vis='cig96_12.ms', caltype='opac', caltable='cig96_12.ms.opcac', parameter=myTau)
...
# gencal(vis='cig96_12.ms', caltype='gceff', caltable='cig96_12.ms.gaincurve')
...
gaincal(vis='cig96_12.ms', caltable='cig96_12.ms.delays', field='1', refant='ea10', gaintype='K', gaintable=['cig96_12.ms.antpos'])
...
setjy(vis='cig96_12.ms', listmodels=T)
...
setjy(vis='cig96_12.ms', field='1', modimage='/mnt/scops/data/data/paramimo/casapy-42.2.30986-1-64b/data/nrao/VLA/CalModels/3C48_L.im')
...
gaincal(vis='cig96_12.ms', caltable='cig96_12.ms.bpphase5s', field='1', refant='ea10', calmode='p', solint='5s', minsnr=5.0, gaintable=['cig96_12.ms.antpos', 'cig96_12.ms.delays'])
...
#plotcal(caltable='cig96_12.ms.bpphase5s', xaxis='time', yaxis='phase')

# Apply phase solutions on the fly:

bandpass(vis='cig96_12.ms', caltable='cig96_12.ms.bandpass5s', field='1', refant='ea10', solint='inf', solnorm=T, minsnr=3.0, minblperant=3, gaintable=['cig96_12.ms.bpphase5s', 'cig96_12.ms.antpos', 'cig96_12.ms.delays'], interp=['nearest'])

# We check again the solutions:

#plotcal(caltable='cig96_12.ms.bpphase5s', field='1', xaxis='time', yaxis='phase')  
...
gaincal(vis='cig96_12.ms',caltable='cig96_12.ms.intphase', field='1,2', refant='ea10', calmode='p', solint='5s', minsnr=5.0, gaintable=['cig96_12.ms.antpos', 'cig96_12.ms.delays', 'cig96_12.ms.bandpass5s'])
...
gaincal(vis='cig96_12.ms', caltable='cig96_12.ms.scanphase', field='1,2', refant='ea10', calmode='p', solint='inf', minsnr=5.0, gaintable=['cig96_12.ms.antpos', 'cig96_12.ms.delays', 'cig96_12.ms.bandpass5s'])

# Derive amplitude solutions:

# time.sleep(5)

gaincal(vis='cig96_12.ms', caltable='cig96_12.ms.amp', field='1',  refant='ea10', calmode='ap', solint='inf', minsnr=5.0, gaintable=['cig96_12.ms.antpos', 'cig96_12.ms.delays', 'cig96_12.ms.bandpass5s', 'cig96_12.ms.intphase'], gainfield=['','','','1'],append=True)

gaincal(vis='cig96_12.ms', caltable='cig96_12.ms.amp', field='2',  refant='ea10', calmode='ap', solint='inf', minsnr=5.0, gaintable=['cig96_12.ms.antpos', 'cig96_12.ms.delays', 'cig96_12.ms.bandpass5s', 'cig96_12.ms.intphase'], gainfield=['','','','2'],append=True)
...
# #plotcal(caltable='cig96_12.ms.amp', xaxis='time', yaxis='amp', iteration='antenna', subplot=331)
# #plotcal(caltable='cig96_12.ms.amp', xaxis='time', yaxis='amp', iteration='baseline', subplot=331)
...
myflux = fluxscale(vis='cig96_12.ms', caltable='cig96_12.ms.amp', fluxtable='cig96_12.ms.flux', reference='1', transfer='2', incremental=False)

# Result:
# Flux density for J0238+1636 in SpW=0 (freq=1.40523e+09 Hz) is: 0.734111 +/- 0.00667783 (SNR = 109.933, N = 52)
...
applycal(vis='cig96_12.ms', field='1', gaintable=['cig96_12.ms.antpos', 'cig96_12.ms.delays', 'cig96_12.ms.bandpass5s', 'cig96_12.ms.intphase', 'cig96_12.ms.flux'], gainfield=['','','','1',''], calwt=F)

# time.sleep(5)

applycal(vis='cig96_12.ms', field='2', gaintable=['cig96_12.ms.antpos', 'cig96_12.ms.delays', 'cig96_12.ms.bandpass5s', 'cig96_12.ms.intphase', 'cig96_12.ms.flux'], gainfield=['','','','2',''], calwt=F)

# time.sleep(5)

# For the target sources we use the scanphase.gcal table:

applycal(vis='cig96_12.ms', field='3', gaintable=['cig96_12.ms.antpos', 'cig96_12.ms.delays', 'cig96_12.ms.bandpass5s', 'cig96_12.ms.scanphase', 'cig96_12.ms.flux'], gainfield=['','','','2',''], calwt=F)
...
# cvel(vis='cig96_12.ms', outputvis='cig96_12.ms.cvel', mode='velocity', field='', spw='0', restfreq='1.42040575177GHz', outframe='LSRK', veltype='radio')
# 
# 
# # ===============================================================================
# 
...
# 
# split(vis='cig96_12.ms.cvel', datacolumn='corrected', outputvis='cig96_12.cvel.corr.ms', field='3', spw='0:400~1700')
# 
...
# 
# # split(vis='cig96_12.ms', datacolumn='corrected', outputvis='cig96_12.corr.spw0.ms', field='3', spw='0')
# 
...
# 
# # split(vis='cig96_12.ms', datacolumn='corrected', outputvis='cig96_12.corr.emission.ms', field='3', spw='0:780~1600')
# 
# # Splitting CIG96 fields in spw=0 with time binning of 20s and channel width of 10 channels:
# 
# split(vis='cig96_12.ms.cvel', datacolumn='corrected', outputvis='cig96_12.corr.20s.10chan.ms', width=10, timebin='20s', field='3', spw='0:451~1700')
# 
# # ===============================================================================
# 
...
# 
# uvcontsub(vis='cig96_12.cvel.corr.ms', field='0', fitspw='0:50~350;900~1050', fitorder=1)
# uvcontsub(vis='cig96_12.corr.20s.10chan.ms', field='0', fitspw='0:15~30;90~105', fitorder=1)
# 
...
# 
# # uvcontsub(vis='cig96_12.corr.emission.ms', field='0', fitspw='0:0~510;710~1300')
# 
# # For the time-channel binned file, we subtract as follows:
# 
# # uvcontsub(vis='cig96_12.corr.20s.10chan.ms', field='0', fitspw='0:45~93;110~181')
# 
# # For the whole spw 0 we use an as extended as possible continuum:
# 
# # uvcontsub(vis='cig96_12.corr.spw0.ms', field='0', fitspw='0:300~365;396~460;490~920;1110~1520')
# 
# # ===============================================================================
# 
...
# 
# clean(vis='cig96_12.cvel.corr.ms.contsub', imagename='cig96_12.cvel.corr.contsub.natural.line', field='0', spw='0:450~800', mode='frequency', start=450, nchan=351, niter=10000, width='48.830kHz', threshold='1.5mJy', interactive=T, npercycle=100, imsize=[200,200], phasecenter='', cell='8.0arcsec', restfreq='1.42040575177GHz', weighting='natural', usescratch=T)
# 
# # Beam size: 37.75 x 17.89 arcsec2
# 
...
# 
# clean(vis='cig96_12.corr.ms.contsub', imagename='cig96_12.corr.v3.contsub.uniform.line', field='0', spw='0:510~730', mode='channel', start=0, niter=10000, threshold='1.2mJy', interactive=T, npercycle=100, imsize=[200,200], phasecenter='', cell='15.0arcsec', restfreq='1.4204GHz', weighting='uniform', usescratch=T)
# 
# # Beam size: 
# 
# # Weighting Briggs rob=0.0:
# 
# clean(vis='cig96_12.corr.ms.contsub', imagename='cig96_12.corr.v3.contsub.rob0.0.line', field='0', spw='0:510~730', mode='channel', start=0, niter=10000, threshold='1.2mJy', interactive=T, npercycle=100, imsize=[200,200], phasecenter='', cell='15.0arcsec', restfreq='1.4204GHz', weighting='briggs', robust='0.0', usescratch=T)
# 
# # Beam size: 
# 
# 
...
# 
# immoments(imagename='cig96_12.cvel.corr.contsub.natural.line.image', axis='spectral', moments=[0,1], outfile='cig96_12.cvel.corr.contsub.natural.line.image.mom')
# 
# 
...
# 
# ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ----
# (cig96_12.corr.contsub.line.image)
...
# # Weighting natural:
# 
# clean(vis='cig96_12.corr.20s.10chan.ms.contsub', imagename='cig96_12.corr.20s.10chan.ms.contsub.natural.line.image', field='0', spw='0:93~110', mode='channel', start=0, niter=1000, threshold='1.2mJy', interactive=T, npercycle=100, imsize=[200,200], phasecenter='', cell='15.0arcsec', restfreq='1.4204GHz', weighting='natural', usescratch=T)
# 
# # For the spw 0 split dataset:
# 
# clean(vis='cig96_12.corr.spw0.ms.contsub', imagename='cig96_12.corr.spw0.ms.contsub.natural.line', field='0', spw='0:920~1110', mode='channel', start=920, nchan=190, niter=10000, threshold='1.2mJy', interactive=T, npercycle=100, imsize=[200,200], phasecenter='', cell='10.0arcsec', restfreq='1.4204GHz', weighting='natural', usescratch=T)
# 
# # ===============================================================================
# 
...
# 
# split(vis='cig96_12.ms', datacolumn='corrected', outputvis='cig96_12.corr.v2.ms', field='3', spw='0:399~2047')
# split(vis='cig96_12.ms', datacolumn='corrected', outputvis='cig96_12.corr.allfields.ms', field='1~3', spw='0')
# 
# # and redo uvcontsub:
# 
...
# 
# uvcontsub(vis='cig96_12.corr.v2.ms', field='0', fitspw='0:0~510;730~1300')
# 
# # Cleaning: weighting natural:
# 
# clean(vis='cig96_12.corr.v2.ms.contsub', imagename='cig96_12.corr.v2.contsub.natural.line', field='0', spw='0:510~730', mode='channel', start=0, niter=10000, threshold='1.2mJy', interactive=T, npercycle=100, imsize=[300,300], phasecenter='', cell='15.0arcsec', restfreq='1.4204GHz', weighting='natural', usescratch=T)
# 
# 
# 
# 
